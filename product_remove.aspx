<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="product_remove.aspx.cs" Inherits="Deliverable2.product_remove" %>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <asp:TableCell runat="server" id="TableCell1">
                               <asp:CheckBox ID="AllowedProduct" runat="server" Checked="true" />
                        </asp:TableCell>
                    </tbody>
                </table>
            </div>
