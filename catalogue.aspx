                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <asp:HyperLink ID="hyper_product4" runat="server" href="product.aspx">
                            <div class="text-center">
                                <asp:Image ID="img_newproduct4" runat="server" src="logo_large.png" CssClass="img-fluid w-75" AlternateText="Product_Image"/>
                            </div>
                        </asp:HyperLink>
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <asp:HyperLink ID="hyper_product5" runat="server" href="product.aspx">
                            <div class="text-center">
                                <asp:Image ID="img_newproduct5" runat="server" src="logo_large.png" CssClass="img-fluid w-75" AlternateText="Product_Image"/>
                            </div>
                        </asp:HyperLink>
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <asp:HyperLink ID="hyper_product6" runat="server" href="product.aspx">
                            <div class="text-center">
                                <asp:Image ID="img_newproduct6" runat="server" src="logo_large.png" CssClass="img-fluid w-75" AlternateText="Product_Image"/>
                            </div>
                        </asp:HyperLink>
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <asp:HyperLink ID="hyper_product7" runat="server" href="product.aspx">
                            <div class="text-center">
                                <asp:Image ID="img_newproduct7" runat="server" src="logo_large.png" CssClass="img-fluid w-75" AlternateText="Product_Image"/>
                            </div>
                        </asp:HyperLink>
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <asp:HyperLink ID="hyper_product8" runat="server" href="product.aspx">
                            <div class="text-center">
                                <asp:Image ID="img_newproduct8" runat="server" src="logo_large.png" CssClass="img-fluid w-75" AlternateText="Product_Image"/>
                            </div>
                        </asp:HyperLink>
                        <div class="card-body">
                ...
                <div class="col">
                    <div class="card shadow-sm">
                        <asp:HyperLink ID="hyper_product9" runat="server" href="product.aspx">
                            <div class="text-center">
                                <asp:Image ID="img_newproduct9" runat="server" src="logo_large.png" CssClass="img-fluid w-75" AlternateText="Product_Image"/>
                            </div>
                        </asp:HyperLink>
                        <div class="card-body">
