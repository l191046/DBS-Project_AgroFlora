...
namespace Agroflora
{
	public partial class home : System.Web.UI.Page
	{
		...
		public void load_new_products()
		{
			...
			hyper_newproduct1.Attributes.Add("href", "product.aspx" + "?PID=" + ds.Tables[0].Rows[0]["ProductID"]);
			...
			hyper_newproduct2.Attributes.Add("href", "product.aspx" + "?PID=" + ds.Tables[0].Rows[1]["ProductID"]);
			...
			hyper_newproduct3.Attributes.Add("href", "product.aspx" + "?PID=" + ds.Tables[0].Rows[2]["ProductID"]);
		...
		public void load_popular_products()
		{
			...
			hyper_popproduct1.Attributes.Add("href", "product.aspx" + "?PID=" + ds.Tables[0].Rows[0]["ProductID"]);
			datetime = ds.Tables[0].Rows[0]["DateAdded"].ToString();
			DateTime.TryParse(datetime, out add_date);
			...
			hyper_popproduct2.Attributes.Add("href", "product.aspx" + "?PID=" + ds.Tables[0].Rows[1]["ProductID"]);
			datetime = ds.Tables[0].Rows[1]["DateAdded"].ToString();
			DateTime.TryParse(datetime, out add_date);
			...
			hyper_popproduct3.Attributes.Add("href", "product.aspx" + "?PID=" + ds.Tables[0].Rows[2]["ProductID"]);
			datetime = ds.Tables[0].Rows[2]["DateAdded"].ToString();
			DateTime.TryParse(datetime, out add_date);
