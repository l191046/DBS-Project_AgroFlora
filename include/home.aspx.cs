...
namespace Agroflora
{
	public partial class home : System.Web.UI.Page
	{
		...
		public void load_new_products()
		{
			...
			img_newproduct1.Attributes.Add("src", "images\\products\\" + ds.Tables[0].Rows[0]["Image"]);
			...
			img_newproduct2.Attributes.Add("src", "images\\products\\" + ds.Tables[0].Rows[1]["Image"]);
			...
			img_newproduct3.Attributes.Add("src", "images\\products\\" + ds.Tables[0].Rows[2]["Image"]);
		...
		public void load_popular_products()
		{
			...
			img_popproduct1.Attributes.Add("src", "images\\products\\" + ds.Tables[0].Rows[0]["Image"]);
			datetime = ds.Tables[0].Rows[0]["DateAdded"].ToString();
			DateTime.TryParse(datetime, out add_date);
			...
			img_popproduct2.Attributes.Add("src", "images\\products\\" + ds.Tables[0].Rows[1]["Image"]);
			datetime = ds.Tables[0].Rows[1]["DateAdded"].ToString();
			DateTime.TryParse(datetime, out add_date);
			...
			img_popproduct3.Attributes.Add("src", "images\\products\\" + ds.Tables[0].Rows[2]["Image"]);
			datetime = ds.Tables[0].Rows[2]["DateAdded"].ToString();
			DateTime.TryParse(datetime, out add_date);
