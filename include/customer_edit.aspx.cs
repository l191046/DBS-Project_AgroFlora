	...
	public partial class customer_edit : System.Web.UI.Page
	{
		...
		protected void load_customer()
		{
			...
			else
			{
				...
				txt_creditcard.Text = dt.Rows[0]["CreditCard"].ToString();
			}
		}
		...
		protected void btn_save_Click(object sender, EventArgs e)
		{
			...
			string creditcard = txt_creditcard.Text;

			if (objDAL.edit_customer(uname, fname, lname, email, address, dob, contact, creditcard) == -1)
			{
				Response.Redirect("error.aspx");
			}
			else
